export const MODULES = [
  {
    ...
    extraCards: [{id: 'when-their-meltdown-triggers-yours', label: 'When their meltdown triggers yours', note: 'The moment this module is built around.'}, {id: 'the-shame-spiral-after-losing-it', label: 'The shame spiral after losing it', note: 'For after the gap happens.'}, {id: 'both-of-us-have-adhd-and-the-house-is-in-freefall', label: 'Both of us have ADHD and the house is in freefall', note: 'The structural reality named plainly.'}],
  ...
  },
  {
    ...
    suggestedFor: ['reactor','juggler','looper','spiraller','escaper'],
    cardLink: { id: 'when-their-meltdown-triggers-yours', label: 'When their meltdown triggers yours' },
    extraCards: [{id: 'when-their-meltdown-triggers-yours', label: 'When their meltdown triggers yours', note: 'What the signal looks like in a specific moment.'}, {id: 'i-lost-it-over-something-tiny-because-the-whole-day-had-stacked-up', label: 'I lost it over something tiny because the whole day had stacked up', note: 'The stack made visible.'}, {id: 'medication-timing-making-home-worse-than-work', label: 'Medication timing making home worse than work', note: 'Why the mask drops at the door.'}],
  ...
  },
  {
    ...
    extraCards: [{id: 'the-repair-after-rupture', label: 'The repair after rupture', note: 'Start here.'}, {id: 'overcorrecting-with-affection-right-after-losing-it', label: 'Overcorrecting with affection right after losing it', note: 'When the overreach replaces repair.'}, {id: 'when-you-said-the-thing-that-caused-real-damage', label: 'When you said the thing that caused real damage', note: 'For harder repairs.'}],
  ...
  },
  {
    ...
    extraCards: [{id: 'i-lost-it-over-something-tiny-because-the-whole-day-had-stacked-up', label: 'I lost it over something tiny because the whole day had stacked up', note: 'The stack made visible.'}, {id: 'when-their-meltdown-triggers-yours', label: 'When their meltdown triggers yours', note: 'Finding the signal in a specific moment.'}],
  ...
  },
  {
    ...
    extraCards: [{id: 'when-you-lectured-instead-of-stopping', label: 'When you lectured instead of stopping', note: 'Start here.'}, {id: 'the-argument-loop', label: 'The argument loop', note: 'When the loop has already started.'}],
  ...
  },
  {
    ...
    extraCards: [{"id": "losing-the-paperwork-the-date-the-appointment", "label": "Losing the paperwork, the date, the appointment", "note": "The invisible steps failing."}, {"id": "starting-to-help-and-getting-distracted-before-you-finished", "label": "Starting to help and getting distracted before you finished", "note": "When you're in the system but drift out."}],
  ...
  },
  {
    ...
    extraCards: [{id: 'i-built-a-perfect-system-and-abandoned-it-after-three-days', label: 'I built a perfect system and abandoned it after three days', note: 'The collapse named.'}, {id: 'starting-to-help-and-getting-distracted-before-you-finished', label: 'Starting to help and getting distracted before you finished', note: 'When the routine drifts mid-execution.'}],
  ...
  },
  {
    ...
    extraCards: [{id: 'the-argument-loop', label: 'The argument loop', note: 'Start here.'}, {id: 'when-you-lectured-instead-of-stopping', label: 'When you lectured instead of stopping', note: 'When the explanation keeps going.'}],
  ...
  },
  {
    ...
    suggestedFor: ['looper'],
    cardLink: { id: 'when-you-lectured-instead-of-stopping', label: 'When you lectured instead of stopping' },
    extraCards: [{id: 'when-you-lectured-instead-of-stopping', label: 'When you lectured instead of stopping', note: 'The stop in action.'}, {id: 'the-argument-loop', label: 'The argument loop', note: 'For understanding why stopping feels like losing.'}],
  ...
  },
  {
    ...
    extraCards: [{"id": "the-shame-spiral-after-losing-it", "label": "The shame spiral after losing it", "note": "Start here."}, {"id": "repeating-your-own-parents-behaviour", "label": "Repeating your own parents' behaviour", "note": "When the spiral goes deep."}],
  ...
  },
  {
    ...
    extraCards: [{id: 'the-repair-after-rupture', label: 'The repair after rupture', note: 'What the repair actually looks like.'}, {id: 'overcorrecting-with-affection-right-after-losing-it', label: 'Overcorrecting with affection right after losing it', note: 'The overreach that replaces repair.'}],
  ...
  },
  {
    ...
    extraCards: [{id: 'leaving-when-you-should-have-stayed', label: 'Leaving when you should have stayed', note: 'For understanding what the absence costs.'}, {id: 'shutting-down-and-going-cold', label: 'Shutting down and going cold', note: 'The shutdown before the return.'}],
  ...
  },
  {
    ...
    extraCards: [{id: 'my-partner-and-i-parent-completely-differently-and-its-splitting-us', label: 'My partner and I parent completely differently', note: 'Start here.'}, {id: 'one-of-us-stays-calm-and-the-other-one-escalates', label: 'One of us stays calm and the other escalates', note: 'The asymmetric version.'}, {id: 'we-fight-about-whether-this-is-adhd-or-bad-behaviour', label: 'We fight about whether this is ADHD or bad behaviour', note: 'A common version of different versions.'}],
  ...
  },
  {
    ...
    extraCards: [{id: 'my-other-child-is-getting-the-leftovers-of-me', label: 'My other child is getting the leftovers of me', note: 'Start here.'}, {id: 'my-other-child-is-starting-to-hate-their-adhd-sibling', label: 'My other child is starting to hate their ADHD sibling', note: 'When the resentment has built.'}],
  ...
  },
  {
    ...
    extraCards: [{id: 'the-school-called-again-and-i-am-dreading-the-conversation', label: 'The school called again and I am dreading the conversation', note: 'Start here.'}, {id: 'the-iep-or-accommodation-meeting-left-me-feeling-dismissed', label: 'The IEP meeting left me feeling dismissed', note: 'When advocacy fails in the room.'}],
  ...
  },
  {
    ...
    extraCards: [{id: 'i-think-there-is-something-else-going-on-underneath-the-adhd', label: 'I think there is something else going on underneath the ADHD', note: 'Start here.'}, {id: 'someone-questioned-whether-my-child-really-has-adhd', label: 'Someone questioned whether my child really has ADHD', note: 'When the complexity gets challenged.'}],
  ...
  },
  {
    ...
    extraCards: [{id: 'i-am-always-waiting-for-the-next-explosion', label: 'I am always waiting for the next explosion', note: 'Where to go when the course ends and the moment happens.'}, {id: 'the-repair-after-rupture', label: 'The repair after rupture', note: 'The most useful ongoing card.'}, {id: 'both-of-us-have-adhd-and-the-house-is-in-freefall', label: 'Both of us have ADHD and the house is in freefall', note: 'For the hard days.'}],
